package JavaCore.task12.task1201;
...
5. Переопределить метод getName в классе Whale(Кит),
чтобы программа выводила на экран: "Я не корова, Я - кит."
6. Метод main() должен выводить на экран результат
